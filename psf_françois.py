...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r",
        "--ref",
        help="Reference Image filename (i.e. ground truth) (required)",
        type=str,
        required=True,
    )
    parser.add_argument(
        "-i",
        "--input",
        help="Low-resolution image filename (required), created using ITK-based Resampling",
        type=str,
        required=True,
    )
    parser.add_argument(
        "-o",
        "--output",
        help="Low-resolution simulated image filename (required)",
        type=str,
        required=True,
    )
