...
Potential pitfalls:
    Coords are correctly ordered before training in the coords variable
...
# siren network
class SirenNet_delta(pl.LightningModule):
    '''
    PURPOSE:
...
# i = 5
# c = trimesh.Trimesh(vertices=Y[24576 * i:24576 * (i + 1)], faces=faces, vertex_normals=normals)
# c.export('test.stl')
